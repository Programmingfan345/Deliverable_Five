...
$userName  = $_SESSION['user_name']  ?? 'Transit User';
...
<div class="app-container">
    ...
    <div class="page active" id="page-home">
        <div class="content">
            ...
            <div class="quick-actions">
                ...
                <div class="quick-action" onclick="alert('Nearby stops feature coming soon!')">
                    <div class="quick-action-icon">📍</div>
    ...
    <div class="page" id="page-tracker">
        <div class="content">
            ...
            <button class="btn-primary" onclick="alert('🔔 Notifications enabled!')">
    ...
    <div class="page" id="page-saved">
        <div class="content">
            ...
            <button class="btn-primary" onclick="alert('Export feature coming soon!')">
                Export Trip History
            </button>
        </div>
    </div>
    ...
    <div class="page" id="page-settings">
        <div class="content">
            ...
            <ul class="settings-list">
                <li class="settings-item" onclick="alert('Edit profile coming soon')">
                ...
                <li class="settings-item" onclick="alert('Payment methods coming soon')">
                    <div class="settings-item-left">
                        <div class="settings-icon">💳</div>
                        <div class="settings-text">
            ...
            <ul class="settings-list">
                ...
                <li class="settings-item" onclick="alert('Theme settings coming soon')">
                    <div class="settings-item-left">
                        <div class="settings-icon">🎨</div>
                        <div class="settings-text">
                            <h4>Theme</h4>
            ...
            <ul class="settings-list">
                <li class="settings-item" onclick="alert('Help Center coming soon')">
                    <div class="settings-item-left">
                        <div class="settings-icon">❓</div>
                        <div class="settings-text">
                            <h4>Help Center</h4>
            ...
            <button class="btn-primary"
                    ...
                    style="background: transparent; border: 2px solid #d4af37; color: #d4af37; margin-top: 30px;">
                Log Out
            </button>
        </div>
    </div>
